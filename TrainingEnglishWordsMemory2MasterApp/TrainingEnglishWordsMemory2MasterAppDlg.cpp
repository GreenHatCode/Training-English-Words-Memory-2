...
{
	// TODO: Add create training file window
	FileEditorWindow newWindow;
...
{
	// TODO: Add create testing file window
	FileEditorWindow newWindow;
	this->ShowWindow(SW_HIDE);
	newWindow.DoModal();
	this->ShowWindow(SW_SHOW);
...
void CTrainingEnglishWordsMemory2MasterAppDlg::DoPlugWindow(CDialog* ptr)
{
	PlugWindow newWindow;
